(function($) {
    ...
    var portfolioCube = function() {
        if ( $().cubeportfolio ) {
            $('.finax-project-grid').each(function() {
                var
                $this = $(this),
    ...
    var imagesCube = function() {
        $('.finax-images-grid').each(function() {
            var
            $this = $(this),
            layout = $this.data("layout"),
            item = $this.data("column"),
    ...
    var carouselBoxOwl = function() {
        if ( $().owlCarousel ) {
            $('.finax-carousel-box').each(function(){
                var
                $this = $(this),
                auto = $this.data("auto"),
                loop = $this.data("loop"),
    ...
    var accordions = function() {
        $('.finax-accordions').each(function() {
        ...
        function run_animations() {
            ...
            setInterval(function () {
                if (did_scroll) {
                    ...
                    $('.finax-counter').each(function() {
                        var $this = $(this);

                        if ( finaxInview($this) && !$this.data('complete') ) {
    ...
    var progressBar = function() {
        if ( $().appear ) {
            var $section = $('.finax-progress').appear(function() {
            ...
            function runBars() {
                ...
                $(function(){
                  $(bar).each(function(){
                    ...
                    $(this).parents('.finax-progress').find('.perc').addClass('show').width(bar_width + '%');
                  });
                });
            }
    ...
    var elmentHover = function() {
        $(".finax-image-video .icon").hover(function(){
            $(this).css({
    ...
    var resizeHeading = function() {
        $(window).on('load resize', function() {
            $('.finax-sheading, .finax-headings').each(function() {
                var
                $this = $(this),
                font = $this.data("font"),
    ...
    var hereSection =  function() {
        ...
        if ( $('.finax-fancy-text').is('.scroll') ) {
            $('.finax-fancy-text.scroll').each(function() {
                var
                $this = $(this),
                current = 1,
                height = $this.height(),
        ...
        if ( $('.finax-fancy-text').is('.typed') ) {
            if ( $().typed ) {
                $('.finax-fancy-text.typed').each(function() {
                    var
                    $this = $(this),
    ...
    var fitText =  function() {
        if ( $().fitText ) {
            $('.finax-fancy-text').each(function(){
    ...
    var tabs =  function() {
        $('.finax-tabs').each(function(){
            ...
            $(this).find('.tab-title li').on('click', function(e) {
                var
                idx = $(this).index(),
                content = $(this).closest('.finax-tabs').find('.tab-content-wrap').children().eq(idx);
    ...
    var srollTarget = function() {
        $('.finax-scroll-target').on('click',function() {
    ...
    var testimonials = function() {
        if ( $().bxSlider ) {
            $('.finax-testimonials-g3 .content-wrap').bxSlider({
                mode: 'horizontal',
                touchEnabled: true,
                oneToOneTouch: true,
    ...
    var dynamicStyle = function() {
        ...
        $('.finax-button.custom').each( function() {
            var
            cn = $(this).attr('class').split(' '),
            cl = '';
        ...
        $('.finax-content-box > .inner').each( function() {
            var
            cn = $(this).attr('class').split(' '),
            cl = '';
        ...
        if ( css ) $("head").append('<style type="text/css" id="finax-dynamic-css">' + css + '</style>');
    };
    ...
    var contentBox = function() {
        $(window).on('load resize', function() {
            ...
            $('.finax-content-box').each(function(){
                if ( mode == 'desktop' ) {
